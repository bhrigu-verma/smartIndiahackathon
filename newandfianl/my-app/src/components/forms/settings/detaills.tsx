  ...
  return (
    <Card className="w-full grid grid-cols-1 lg:grid-cols-2">
      <CardContent className="p-6 border-r-[1px]">
        <CardTitle>Tell Bot more  </CardTitle>
        <form
        ...
        >
          <div className="flex flex-col gap-3">
            <Section
              label="Question"
              message="tell the bot how do you want it to answer wit some samples "
            />
            <FormGenerator
              inputType="input"
              register={register}
              ...
              name="question"
              placeholder="what is your buisness all about"
              type="text"
            />
          </div>
          <div className="flex flex-col gap-3">
            ...
            <FormGenerator
              ...
              form="filter-questions-form"
              name="answer"
              placeholder="we sell ai products and systems to integrate "
              type="text"
              lines={5}
            />
          </div>
